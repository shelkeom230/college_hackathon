...
<header>
 <nav>
  <ul>
   ...
   <li><a href="dashboard.php">GreenWaveInnovation || spcoet</a></li>
  </ul>
 </nav>
</header>
<div id="center">
...
<h3 style="text-align: center;">You are now logged in. you can logout by clicking on signout link given below.</h3>
<div id="contentbox">
<?php
$sql="SELECT * FROM student_list where mem_id=$loggedin_id";
