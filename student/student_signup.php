...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // SQL query to insert data into the "student_list" table
    $sql = "INSERT INTO `student_list` (`Name`, `Surname`, `Email`, `Contact_Number`, `username`, `password`) 
            VALUES ('$name', '$surname', '$email', '$contactnumber', '$username', '$hashedPassword')";

    // Execute the SQL query
    if ($con->query($sql) === TRUE) {
        // Data inserted successfully
        echo "Registration successful. You can now <a href='student_signin.php'>sign in</a>.";
    } else {
        // Error occurred while inserting datas
...
<head>
    ...
    <title>Student || Student Signup</title>
</head>
<style>
    h1{
    overflow-y: hidden;
    ...
    <div class="container", style="width: 400px;height: 500px">
        ...
        <form action="student_signup.php" method="POST" enctype="multipart/form-data">
           ...
           <div class="mb-0">
            ...
            <p>Already have an account ?<a href="student_signin.php">sign in</a></p>
        </form>
    </div>
</body>
</html>
